...
public class Entity : ISelectable, IDisposable
{
    ...
    /// Default constructor.
    /// </summary>
    public Entity(MapEditor editor)
    {
        Editor = editor;
    }
    ...
    /// </summary>
    public Entity(MapEditor editor, ObjectContainer map, object msbo)
    {
        Editor = editor;
        Container = map;
        WrappedObject = msbo;
    ...
    public object GetPropertyValue(string prop)
    {
        ...
        else if (WrappedObject is MapParamRow mrow)
        {
    ...
    public bool IsRotationPropertyRadians(string prop)
    {
        ...
        if (WrappedObject is Param.Row row || WrappedObject is MapParamRow mrow)
        {
            return false;
        }
    ...
    /// </summary>
    public MapEditorNS.PropertiesChangedAction GetPropertyChangeAction(string prop, object newval)
    {
        if (WrappedObject == null)
        {
            return null;
        ...
        if (WrappedObject is Param.Row row)
        {
            ...
            if (pp != null)
            {
                ...
                return new MapEditorNS.PropertiesChangedAction(pprop, pp, newval);
            }
        }

        if (WrappedObject is MapParamRow mrow)
        {
            Param.Cell? pp = mrow[prop];
            if (pp != null)
            {
        ...
        if (p != null)
        {
            return new MapEditorNS.PropertiesChangedAction(p, WrappedObject, newval);
        }
    ...
    public virtual void BuildReferenceMap()
    {
        ...
        if (!(WrappedObject is Param.Row) && !(WrappedObject is MapParamRow))
        {
    ...
    public ViewportAction GetUpdateTransformAction(Transform newt, bool includeScale = false)
    {
        ...
        if (WrappedObject is Param.Row || WrappedObject is MapParamRow)
        {
            ...
            MapEditorNS.CompoundAction act = new(actions);
        ...
        {
            MapEditorNS.PropertiesChangedAction act = new(WrappedObject);
    ...
    public ViewportAction ChangeObjectProperty(string propTarget, string propValue)
    {
        ...
        var act = new MapEditorNS.CompoundAction(actions);
        act.SetPostExecutionAction((undo) =>
        {
            UpdateRenderModel();
        });
...
{
    public NamedEntity(MapEditor editor, ObjectContainer map, object msbo, string name, int idx) : base(editor, map, msbo)
    {
        Name = name;
        Index = idx;
    }
...
{
    public CollisionEntity(MapEditor editor, ObjectContainer map, object msbo, string name, int idx, HavokCollisionType type) : base(editor, map, msbo)
    {
        Name = name;
        Index = idx;
...
{
    public TransformableNamedEntity(MapEditor editor, ObjectContainer map, object msbo, string name, int idx) : base(editor, map, msbo)
    {
        Name = name;
        Index = idx;
    }
...
public class MsbEntity : Entity
{
    ...
    /// Constructor
    /// </summary>
    public MsbEntity(MapEditor editor)
    {
        Editor = editor;
    }
    ...
    /// </summary>
    public MsbEntity(MapEditor editor, ObjectContainer map, object msbo)
    {
        Editor = editor;
        Container = map;
        WrappedObject = msbo;
    ...
    /// </summary>
    public MsbEntity(MapEditor editor, ObjectContainer map, object msbo, MsbEntityType type)
    {
        Editor = editor;
        Container = map;
        WrappedObject = msbo;
        ...
        if (!(msbo is Param.Row) && !(msbo is MapParamRow))
        {
    ...
    public override void UpdateRenderModel()
    {
        ...
        else if (Type == MsbEntityType.DS2EventLocation && _renderSceneMesh == null)
        {
            ...
            _renderSceneMesh = DrawableHelper.GetDS2EventLocationDrawable(Editor, ContainingMap, this);
        }
        else if (Type == MsbEntityType.Region && _renderSceneMesh == null)
        {
            ...
            _renderSceneMesh = DrawableHelper.GetRegionDrawable(Editor, ContainingMap, this, EntityRenderType);
        }
        else if (Type == MsbEntityType.Light && _renderSceneMesh == null)
        {
            ...
            _renderSceneMesh = DrawableHelper.GetLightDrawable(Editor, ContainingMap, this, EntityRenderType);
        }
        else
        {
            ...
            if (modelProp != null) // Check if ModelName property exists
            {
                ...
                if (modelChanged)
                {
                    ...
                    if (model != null)
                    {
                        _renderSceneMesh = DrawableHelper.GetModelDrawable(Editor, ContainingMap, this, model, true, ModelMasks);
                    }
