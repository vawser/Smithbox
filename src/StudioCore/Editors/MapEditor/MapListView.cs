...
public class MapListView : IActionEventHandler
{
    ...
    private string WindowName = "Map List##mapEditorMapList";
    private string ContentWindowName = "Map Contents##mapEditorContentList";

    public MapListView(MapEditor editor)
    {
        Editor = editor;
    }
    ...
    public void Display()
    {
        ...
        if (Editor.Project.EnableParamEditor && !Editor.Project.ParamData.IsSetup)
            return;
        ...
        {
            Editor.EditorFocus.SetFocusContext(MapEditorContext.MapIdList);
        ...
        {
            UIHelper.ApplyChildStyle();
            if (ImGui.Begin(ContentWindowName))
            {
                Editor.EditorFocus.SetFocusContext(MapEditorContext.MapContents);
