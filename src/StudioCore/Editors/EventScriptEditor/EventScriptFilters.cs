...
/// </summary>
public class EventScriptFilters
{
    public EventScriptEditor Editor;
    public Project Project;

    public EventScriptFilters(Project curProject, EventScriptEditor editor)
    {
        Project = curProject;
        Editor = editor;
    }
    ...
    /// Is the search input an match for the passed text?
    /// </summary>
    public bool IsEventFilterMatch(Event evt)
    {
        var aliasText = EventScriptUtils.GetDS2ItemAlias(evt);
    ...
    public bool IsInstructionFilterMatch(Instruction ins, string overrideInput = "")
    {
        ...
        var argDocName = EventScriptUtils.GetArgDocName(Editor, ins);
        ...
        if (input != "")
        {
            ...
            {
                (var argumentDocs, var arguments) = EventScriptUtils.BuildArgumentList(Editor, ins);
