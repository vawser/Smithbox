...
/// </summary>
public class EventScriptActionHandler
{
    public EventScriptEditor Editor;
    public Project Project;

    public EventScriptActionHandler(Project curProject, EventScriptEditor editor)
    {
        Editor = editor;
        Project = curProject;
    }
    ...
    public void LogUnknownInstructions()
    {
        ...
        foreach (var entry in Editor.Project.EventScriptData.PrimaryBank.EventScripts)
        {
            foreach (var evt in entry.Value.Events)
            {
                ...
                foreach (var ins in evt.Instructions)
                {
                    ...
                    if (!EventScriptUtils.HasArgDoc(Editor, ins))
                    {
