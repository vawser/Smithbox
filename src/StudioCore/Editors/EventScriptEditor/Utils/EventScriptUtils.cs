...
public static class EventScriptUtils
{
    /// <summary>
    ...
    /// </summary>
    public static bool HasArgDoc(EventScriptEditor editor, Instruction ins)
    {
        var classDoc = editor.Project.EventScriptData.EventInformation.Classes.Where(e => e.Index == ins.Bank).FirstOrDefault();
    ...
    /// </summary>
    public static string GetArgDocName(EventScriptEditor editor, Instruction ins)
    {
        var classDoc = editor.Project.EventScriptData.EventInformation.Classes.Where(e => e.Index == ins.Bank).FirstOrDefault();
    ...
    /// </summary>
    public static (List<ArgDoc>, List<object>) BuildArgumentList(EventScriptEditor editor, Instruction ins)
    {
