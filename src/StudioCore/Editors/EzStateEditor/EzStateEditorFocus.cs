...
public class EzStateEditorFocus
{
    ...
    public EzStateEditorContext FocusContext = EzStateEditorContext.None;

    public EzStateEditorFocus(Project curPoject, EzStateEditor editor)
    {
        Editor = editor;
        Project = curPoject;
    }
    ...
    /// </summary>
    public void SetFocusContext(EzStateEditorContext newContext)
    {
