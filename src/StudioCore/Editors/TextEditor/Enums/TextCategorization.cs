...
public enum Menu_MsgBndID_ER
{
    ...
    [Display(Name = "Blood Messages")] Blood_Messages = 2,
    [Display(Name = "Movie Subtitles")] Movie_Subtitles = 3,
    [Display(Name = "Talk Messages (Female)")] Talk_Messages_FemalePC = 4,
    ...
    [Display(Name = "[DLC1] Talk Messages (Female)")] Talk_Messages_FemalePC_DLC1 = 363,
    ...
    [Display(Name = "[DLC2] Talk Messages (Female)")] Talk_Messages_FemalePC_DLC2 = 463,
