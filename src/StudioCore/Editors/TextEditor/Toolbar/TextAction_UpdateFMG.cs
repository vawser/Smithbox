...
{
    public class TextAction_UpdateFMG
    {
        ...
        public static void Select()
        {
            ...
            if (ImGui.RadioButton("Update FMG Files##tool_UpdateFMG", TextToolbar.SelectedAction == TextEditorAction.UpdateFMGs))
            {
                TextToolbar.SelectedAction = TextEditorAction.UpdateFMGs;
            }
            ImguiUtils.ShowHoverTooltip("Ports all unique entries from item.msgbnd.dcx and menu.msgbnd.dcx to the DLC version: item_dlc02.msgbnd.dcx and menu_dlc02.msgbnd.dcx");
        }

        public static void Configure()
        {
            if (TextToolbar.SelectedAction == TextEditorAction.UpdateFMGs)
            {
        ...
        public static void Act()
        {
            if (TextToolbar.SelectedAction == TextEditorAction.UpdateFMGs)
            {
                if (ImGui.Button("Apply##action_Selection_Update", new Vector2(200, 32)))
                {
                    UpdateFMGs();
                }
            }
