...
namespace Hexa.NET.ImGui
{
	public unsafe partial class ImGui
	{
		...
		internal static byte* CalcWordWrapPositionANative(ImFont* self, float scale, byte* text, byte* textEnd, float wrapWidth)
		{
			...
			return ((delegate* unmanaged[Cdecl]<ImFont*, float, byte*, byte*, float, byte*>)funcTable[664])(self, scale, text, textEnd, wrapWidth);
			#else
			return (byte*)((delegate* unmanaged[Cdecl]<nint, float, nint, nint, float, nint>)funcTable[664])((nint)self, scale, (nint)text, (nint)textEnd, wrapWidth);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImFont*, ImDrawList*, float, Vector2, uint, uint, void>)funcTable[665])(self, drawList, size, pos, col, c);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, float, Vector2, uint, uint, void>)funcTable[665])((nint)self, (nint)drawList, size, pos, col, c);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImFont*, ImDrawList*, float, Vector2, uint, Vector4, byte*, byte*, float, byte, void>)funcTable[666])(self, drawList, size, pos, col, clipRect, textBegin, textEnd, wrapWidth, cpuFineClip);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, float, Vector2, uint, Vector4, nint, nint, float, byte, void>)funcTable[666])((nint)self, (nint)drawList, size, pos, col, clipRect, (nint)textBegin, (nint)textEnd, wrapWidth, cpuFineClip);
			#endif
		}
