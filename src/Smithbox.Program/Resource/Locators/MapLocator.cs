...
public static class MapLocator
{
    ...
    public static ResourceDescriptor GetMapMSB(ProjectEntry project, string mapid, bool writemode = false, bool gameRootOnly = false)
    {
        ...
        // BB, DS3, ER, SDT, AC6
        else if (project.ProjectType is ProjectType.BB or ProjectType.DS3 or ProjectType.ER or ProjectType.SDT or ProjectType.AC6 or ProjectType.ERN)
        {
    ...
    public static List<ResourceDescriptor> GetMapBTLs(ProjectEntry project, string mapid, bool writemode = false)
    {
        ...
        else if (project.ProjectType is ProjectType.BB or ProjectType.DS3 or ProjectType.SDT or ProjectType.ER or ProjectType.ERN or ProjectType.AC6)
        {
            string path;
    ...
    {
        if (project.ProjectType is ProjectType.DES or ProjectType.ER or ProjectType.ERN or ProjectType.AC6)
        {
            return mapid;
        }
