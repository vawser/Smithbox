...
public class CFG
{
    ...
    public bool Interface_MapEditor_Tool_Properties_Action = true;
    ...
    public bool TextEditor_Text_Entry_List_Allow_Select_All = false;
    ...
    public bool HavokEditor_EntryList_Display_Aliases = true;
