...
public abstract class DbgPrim : IDbgPrim, IDisposable
{
    ...
    public void UpdatePerFrameResources(GraphicsDevice device, CommandList cl, SceneRenderPipeline sp)
    {
        if (NeedToRecreateGeomBuffer)
        {
            ...
            {
                GeometryBuffer = SceneRenderer.GeometryBufferAllocator.Allocate(28 * (uint)Vertices.Length,
    ...
    private unsafe void DrawPrimitive(SceneRenderer.IndirectDrawEncoder encoder, SceneRenderPipeline sp)
    {
        ...
        SceneRenderer.IndirectDrawIndexedArgumentsPacked args = new();
    ...
    public void Draw(SceneRenderer.IndirectDrawEncoder encoder, SceneRenderPipeline sp, IDbgPrim parentPrim,
        Matrix4x4 world)
    {
    ...
    public void SubmitRenderObjects(SceneRenderer.RenderQueue queue)
    {
