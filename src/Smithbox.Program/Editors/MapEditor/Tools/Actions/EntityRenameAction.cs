...
public class EntityRenameAction
{
    ...
    public void ApplyMapObjectNames(bool useJapaneseNames)
    {
        ...
        if (TargetMap != (null, null))
        {
            ...
            var compoundAction = new StudioCore.Editors.MapEditor.Actions.Viewport.CompoundAction(actionList);
    ...
    private List<MapObjectNameInfo> GetNameListInfo(string mapId, string type)
    {
        ...
        var dir = Path.Join(Common.FileLocations.Assets, "MSB", ProjectUtils.GetGameDirectory(Editor.Project), "namelist.csv");
