...
public class ModelSelectionMenu
{
    ...
    public ModelSelectionMenu(ModelEditorView view, ProjectEntry project)
    {
        View = view;
        Project = project;
    }
    ...
    public void DisplayFlverSelectionTabs()
    {
        ...
        // Objects / Assets
        var name = LOC.Get("MODEL_FlverSelection_Tab_Objects");
        if (Project.Descriptor.ProjectType is ProjectType.ER or ProjectType.AC6 or ProjectType.NR)
        {
            name = LOC.Get("MODEL_FlverSelection_Tab_Assets");
        }
        ...
        // Map Pieces
        if (ImGui.BeginTabItem($"{LOC.Get("MODEL_FlverSelection_MapPieces")}##mapPieceTab"))
        {
    ...
    public void DisplayFlverSelectionHeader()
    {
        ...
        GUI.Tooltip(LOC.Get("MODEL_FlverSelection_Filter_TT"));
    ...
    public void ReadDirect(FileDictionaryEntry fileEntry)
    {
        if (Project.VFS.FS.FileExists(fileEntry.Path))
        {
            ...
            {
                Smithbox.LogError(this, LOC.Get("MODEL_FlverSelection_Failed_FLVER_Find", fileEntry.Path), ex);
            }
        }
        else
        {
            Smithbox.LogError(this, LOC.Get("MODEL_FlverSelection_Failed_FLVER_Read", fileEntry.Path));
        }
    }
    ...
    public void ReadBND4(FileDictionaryEntry fileEntry)
    {
        if (Project.VFS.FS.FileExists(fileEntry.Path))
        {
            ...
            {
                Smithbox.LogError(this, LOC.Get("MODEL_FlverSelection_Failed_Binder_Read", fileEntry.Path), e);
            }
        }
        else
        {
            Smithbox.LogError(this, LOC.Get("MODEL_FlverSelection_Failed_Binder_Find", fileEntry.Path));
        }
    }
    ...
    public void ReadBXF(FileDictionaryEntry fileEntry)
    {
        ...
        {
            Smithbox.LogError(this, LOC.Get("MODEL_FlverSelection_Failed_Binder_Find", targetBhdPath));
        }
    }
    ...
    public void LoadFlverFile(FileDictionaryEntry fileEntry, Memory<byte>? fileData)
    {
        ...
        {
            Smithbox.LogError(this, LOC.Get("MODEL_FlverSelection_Failed_FLVER_Read", fileEntry.Filename), e);
        }
    }
}
