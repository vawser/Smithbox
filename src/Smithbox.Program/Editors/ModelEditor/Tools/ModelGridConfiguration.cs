...
public class ModelGridConfiguration
{
    ...
    public void Display()
    {
        if (ImGui.CollapsingHeader("Model Grid Configuration"))
        {
            ...
            ImGui.InputFloat("Grid Position: X", ref CFG.Current.ModelEditor_Viewport_Grid_Position_X);
            UIHelper.Tooltip("The position of the grid on the X-axis.");

            ImGui.InputFloat("Grid Position: Y", ref CFG.Current.ModelEditor_Viewport_Grid_Position_Y);
            UIHelper.Tooltip("The position of the grid on the Y-axis.");

            ImGui.InputFloat("Grid Position: Z", ref CFG.Current.ModelEditor_Viewport_Grid_Position_Z);
            ...
            ImGui.InputFloat("Grid Rotation: X", ref CFG.Current.ModelEditor_Viewport_Grid_Rotation_X);
            UIHelper.Tooltip("The rotation of the grid on the X-axis.");

            ImGui.InputFloat("Grid Rotation: Y", ref CFG.Current.ModelEditor_Viewport_Grid_Rotation_Y);
            UIHelper.Tooltip("The rotation of the grid on the Y-axis.");

            ImGui.InputFloat("Grid Rotation: Z", ref CFG.Current.ModelEditor_Viewport_Grid_Rotation_Z);
            ...
            ImGui.InputInt("Square Size", ref CFG.Current.ModelEditor_Viewport_Grid_Square_Size);
            if (ImGui.IsItemDeactivatedAfterEdit())
            {
                CFG.Current.ModelEditor_Viewport_RegenerateMapGrid = true;
            }
            ...
            ImGui.InputInt("Grid Size", ref CFG.Current.ModelEditor_Viewport_Grid_Size);
            if (ImGui.IsItemDeactivatedAfterEdit())
            {
                CFG.Current.ModelEditor_Viewport_RegenerateMapGrid = true;
            }
