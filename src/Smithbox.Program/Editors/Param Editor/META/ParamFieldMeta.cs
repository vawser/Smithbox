...
public class ParamFieldMeta
{
    ...
    public ParamFieldMeta(ParamMeta parent, XmlNode fieldMeta, PARAMDEF.Field field)
    {
        ...
        XmlAttribute FMGRefRoleOverride = fieldMeta.Attributes["FmgRefRoleOverride"];
        if (FMGRefRoleOverride != null)
        {
            FmgRefRoleOverride = FMGRefRoleOverride.InnerText;
        }
    ...
    public string FmgRefRoleOverride { get; set; }
