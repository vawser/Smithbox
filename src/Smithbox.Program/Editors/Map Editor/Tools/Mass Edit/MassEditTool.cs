...
public class MassEditTool
{
    ...
    public void ApplyMassEdit()
    {
        if(!MayRunEdit)
        {
            Smithbox.LogError<MassEditTool>("Mass Edit is already running.");
            return;
        }
    ...
    private void ConfigureMapTarget()
    {
        ...
        // Reset
        if (ImGui.Button("Reset##resetMapSelectionInput", DPI.SelectorButtonSize))
        {
    ...
    private void ConfigureEdit()
    {
        ...
        // Reset
        if (ImGui.Button("Reset##resetEditInputs", DPI.SelectorButtonSize))
        {
    ...
    private async void StartMassEdit()
    {
        ...
        else
        {
            ...
            Smithbox.LogError(this, "Failed to apply MSB Mass Edit, see log for details");
        }
