...
public class MapContainer : ObjectContainer
{
    ...
    public MapContainer(MapEditorScreen editor, string mapid)
    {
        ...
        RootObject = new MsbEntity(Editor.Universe, this, t, MsbEntityType.MapRoot);
        MapOffsetNode = new MsbEntity(Editor.Universe, this, new MapTransformNode(mapid));
    ...
    public void LoadMSB(IMsb msb)
    {
        ...
        {
            var n = new MsbEntity(Editor.Universe, this, p, MsbEntityType.Part);
            Parts.Add(n);
            Objects.Add(n);
        ...
        {
            var n = new MsbEntity(Editor.Universe, this, p, MsbEntityType.Region);
            Regions.Add(n);
            Objects.Add(n);
            RootObject.AddChild(n);
        }
        ...
        {
            var n = new MsbEntity(Editor.Universe, this, p, MsbEntityType.Event);
            Events.Add(n);
        ...
        if(Editor.Project.Descriptor.ProjectType is ProjectType.DS2 or ProjectType.DS2S or ProjectType.DS3)
        {
            if(msb is MSB2 msb2)
            {
                ...
                {
                    var n = new MsbEntity(Editor.Universe, this, entry, MsbEntityType.PartPose);
                    PartPoses.Add(n);
                    Objects.Add(n);
                    RootObject.AddChild(n);
                }
    ...
    {
        var btlParent = new MsbEntity(Editor.Universe, this, curEntry.Filename, MsbEntityType.Editor);
        MapOffsetNode.AddChild(btlParent);
        foreach (BTL.Light l in btl.Lights)
        {
            var n = new MsbEntity(Editor.Universe, this, l, MsbEntityType.Light);
            Objects.Add(n);
    ...
    {
        var autoInvadeParent = new MsbEntity(Editor.Universe, this, mapName, MsbEntityType.Editor);

        MapOffsetNode.AddChild(autoInvadeParent);

        foreach (var point in aip.Points)
        {
            var newEntity = new MsbEntity(Editor.Universe, this, point, MsbEntityType.AutoInvadePoint);
    ...
    {
        var lightAtlasParent = new MsbEntity(Editor.Universe, this, fileName, MsbEntityType.Editor);

        MapOffsetNode.AddChild(lightAtlasParent);

        foreach (var entry in btab.Entries)
        {
            var newEntity = new MsbEntity(Editor.Universe, this, entry, MsbEntityType.LightAtlas);
            newEntity.SupportsName = false;
    ...
    {
        var lightProbeParent = new MsbEntity(Editor.Universe, this, fileName, MsbEntityType.Editor);

        MapOffsetNode.AddChild(lightProbeParent);

        foreach (var volume in btpb.Groups)
        {
            var newEntity = new MsbEntity(Editor.Universe, this, volume, MsbEntityType.LightProbeVolume);
            newEntity.SupportsName = false;
    ...
    {
        var nvaParent = new MsbEntity(Editor.Universe, this, mapName, MsbEntityType.Editor);
        ...
        {
            var newEntity = new MsbEntity(Editor.Universe, this, curNavmesh, MsbEntityType.Navmesh);
        ...
        {
            var newEntity = new MsbEntity(Editor.Universe, this, curEntry, MsbEntityType.Navmesh);
        ...
        foreach (var curEntry in nva.LevelConnectorEntries)
        {
            ...
            var mesh = RenderableHelper.GetLevelConnectorSphereProxy(Editor.RenderScene);
