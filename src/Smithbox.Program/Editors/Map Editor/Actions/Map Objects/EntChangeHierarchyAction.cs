...
public class EntChangeHierarchyAction : ViewportAction
{
    ...
    public EntChangeHierarchyAction(MapEditorView view, List<Entity> src, List<Entity> targetEnts, List<int> targets,
        bool setSelection)
    {
        View = view;
